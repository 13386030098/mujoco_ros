...
int main(int argc, char **argv)
{
    ...
    ros::Publisher pub_pose=nh.advertise<robot_msgs::omega>("omega1/omega_map",100,true);
    ros::Publisher pub_pose_filter=nh.advertise<robot_msgs::omega>("omega1/omega_map_filter",100,true);
    ...
    x_fout.open("x.txt");
    x_fliter_fout.open("x_fliter.txt");
